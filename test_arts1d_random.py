...
def _perturb_params_(rng, params, arbitrary_distribution: bool = False):
    ...
    if arbitrary_distribution:
        params["electron"]["fe"]["params"] = {}
        params["electron"]["fe"]["params"]["init_m"] = float(rng.uniform(2.0, 3.5))
        params["electron"]["fe"]["params"]["learn_log"] = True
...
@pytest.mark.parametrize("arbitrary_distribution", [True, True])
def test_arts1d_inverse(arbitrary_distribution: bool = False):
    """
